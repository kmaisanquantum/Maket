-- ============================================================
-- maket.dspng.tech — Supabase Database Schema
...
create table if not exists public.prices (
  ...
  commodity       text not null check (commodity in ('coffee', 'cocoa')),
...
insert into public.prices (commodity, price_pgk, price_usd, source, region, week_change_pct) values
  ...
  ('coffee', 18.00, 4.89, 'CIC', 'Morobe', 1.1),
  ('cocoa', 14.20, 3.85, 'CCDA', 'East New Britain', 5.7),
  ('cocoa', 13.90, 3.77, 'CCDA', 'West New Britain', 3.2),
